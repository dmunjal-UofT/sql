...
SELECT * FROM customer ORDER by customer_last_name ASC, customer_last_name ASC LIMIT 10;
...
SELECT customer_last_name,customer_first_name, sum((quantity*cost_to_customer_per_qty)) as price 
FROM customer c 
...
SELECT customer_id, strftime('%m',market_date) as month, strftime('%Y',market_date) as year ,  sum((quantity*cost_to_customer_per_qty)) as MoneySpent
 FROM customer_purchases
